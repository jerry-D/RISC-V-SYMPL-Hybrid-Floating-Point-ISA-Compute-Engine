...
assign rewind_PC = (~fp_ready_q1 || ~ready_integer_q1 || write_collision || ~PRNG_ready_q1);
...
assign fat_RAM_rddataA[1023:0] = _3portFatRAM_rdselA_q1 ? fat_RAM_rddataA_HI[1023:0] : fat_RAM_rddataA_LO[1023:0];
assign fat_RAM_rddataB[1023:0] = _3portFatRAM_rdselB_q1 ? fat_RAM_rddataB_HI[1023:0] : fat_RAM_rddataB_LO[1023:0];
...
//       fp_ready_q2        <= fp_ready_q1 &&  FuNN_ready_q1;
       ...
       fat_wrsrcAdataSext <= (fat_rddataA_sel_q1 ||  _3portFatRAM_rdselA_q1) ? fat_RAM_rddataA : (toDecCharRddataA_sel_q1 ? {648'b0, toDecCharRddataA} : {960'b0, ((XPUSH_q2||XPUSHD_q2) ? RISC_V_RAMrddataA : rdSrcAdata)});
       fat_wrsrcBdataSext <= (fat_rddataB_sel_q1 ||  _3portFatRAM_rdselB_q1) ? fat_RAM_rddataB : (toDecCharRddataB_sel_q1 ? {648'b0, toDecCharRddataB} : {960'b0,            (XPUSHD_q2  ? RISC_V_RAMrddataB : rdSrcAdata)});
